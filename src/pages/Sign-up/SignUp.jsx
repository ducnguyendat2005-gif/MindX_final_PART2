      ...
      <div className={styles.mainPage}>
        ...
        <div className={styles.signUpSection}>
          ...
          <div className={styles.firstName}>
            <p>Full name</p>
            <input type="text" placeholder="First name" onChange={(f) => setFName(f.target.value)} />
          </div>
 
          <div className={styles.lastName}>
            <input type="text" placeholder="Last name" onChange={(l) => setLName(l.target.value)}/>
          </div>
 
          <div className={styles.username}>
            <p>Username</p>
            <input type="text" placeholder="Username" onChange={(u) => setuserName(u.target.value)}/>
          </div>
          ...
          <div className={styles.confirmPassword}>
            ...
            <input type="password" placeholder="Confirm Password" onChange={(c) => setcPass(c.target.value)} />
